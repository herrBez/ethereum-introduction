...
\item Design an efficient static analysis technique for EVM bytecode and to
formally prove its soundness against the formal
sematics~\cite{grishchenko2018semantic}
